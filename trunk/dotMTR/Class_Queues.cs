...
namespace MyQueues
{
    ...
    {
        #region Delegates
        public delegate void EnqueuedEventHandler(object sender, EventArgs e);
        public delegate void DequeuedEventHandler(object sender, EventArgs e);
        #endregion
