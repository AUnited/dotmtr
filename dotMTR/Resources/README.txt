### ABOUT
- dotMTR is a modern, graphically enhanced MTR implementation created for Windows.
- dotMTR is written in C# for version 3.5 of the .NET Framework
- dotMTR is copyright 2010 Nate McKay (natemckay@gmail.com)
- dotMTR is free software, licensed under the GNU General Public License, version 2 (http://www.gnu.org/licenses/gpl-2.0.txt)
